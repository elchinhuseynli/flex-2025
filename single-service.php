...
?>
    <!DOCTYPE html>
<html data-wf-page="682070bbebd29d5902b82bd0" data-wf-site="651bf4b86dfb35365e58e1ff" lang="cs">
				...
				<section nav-color="is-light" class="section is-dark-theme">
					<div class="padding-global">
						<div class="container-large">
							<div class="custom-header_content">
								<div class="max-width-medium">
									<h1>Web design & development</h1>
									<div class="margin-top margin-small">
										<p>We deliver innovative and high-performing websites. Our engineering-led approachensures scalable, top-quality sites that push the boundaries of what's possible with Webflow.</p>
									</div>
									<div class="margin-top margin-medium">
										<div class="button-group is-centered"><button popovertarget="project-modal" class="link"><div>Kontaktovat</div></button></div>
									</div>
								</div>
							</div>
						</div>
					</div>
					<div data-us-project="tiL9Ri48KVrYzH7zWlMj" class="bg_full"></div>
				</section>
							...
							<div class="grid">
								<div class="grid_left">
									<div>
										...
										<div class="margin-top margin-medium">
											<p>Flow Ninja provides complete development solution from website migration to automatization and ongoing development strategy and consulting.</p>
										</div>
									</div>
									<div data-poster-url="https://cdn.prod.website-files.com/651bf4b86dfb35365e58e1ff/68208af572e43ce739a13d40_scale-hostingv2-poster-00001.jpg" data-video-urls="https://cdn.prod.website-files.com/651bf4b86dfb35365e58e1ff/68208af572e43ce739a13d40_scale-hostingv2-transcode.mp4,https://cdn.prod.website-files.com/651bf4b86dfb35365e58e1ff/68208af572e43ce739a13d40_scale-hostingv2-transcode.webm" data-autoplay="true" data-loop="true" data-wf-ignore="true" class="single-service_bg-video w-background-video w-background-video-atom">
										<video id="099c1657-df98-f4ab-bdd2-3d7f677c07ef-video" autoplay loop style='background-image:url("https://cdn.prod.website-files.com/651bf4b86dfb35365e58e1ff/68208af572e43ce739a13d40_scale-hostingv2-poster-00001.jpg")' muted playsinline data-wf-ignore="true" data-object-fit="cover">
											<source src="https://cdn.prod.website-files.com/651bf4b86dfb35365e58e1ff/68208af572e43ce739a13d40_scale-hostingv2-transcode.mp4" data-wf-ignore="true"></source>
											<source src="https://cdn.prod.website-files.com/651bf4b86dfb35365e58e1ff/68208af572e43ce739a13d40_scale-hostingv2-transcode.webm" data-wf-ignore="true"></source>
										</video>
									</div>
								</div>
								<div class="grid_right">
									<div fl-accordion slide-animation-trigger class="services_content">
										<div slide-animation-item class="services_item">
											<div fl-accordion-item class="services_item-inner">
												<div fl-accordion-header class="accordion_header">
													<h3 data-blur-scroll class="work_item-heading">Website migration</h3>
												...
												<div fl-accordion-content class="accordion_content">
													<div class="accordion_body">
														<p class="text-wrap-pretty">Proven migration process lead by expert team. Marketing teams leverage Flex Agency's experienced Webflow team to migrate websites from different builders and platforms to Webflow.</p>
													</div>
												</div>
											</div>
										</div>
										<div slide-animation-item class="services_item">
											<div fl-accordion-item class="services_item-inner">
												<div fl-accordion-header class="accordion_header">
													<h3 data-blur-scroll class="work_item-heading">Webflow CMS</h3>
													<div fl-accordion-arrow>
														<svg xmlns="http://www.w3.org/2000/svg" width="100%" viewbox="0 0 22 22" fill="none" class="works_arrow">
															<line x1="11" y1="4.37114e-08" x2="11" y2="22" stroke="currentColor" stroke-width="2"></line>
															<line x1="22" y1="11" x2="-8.74228e-08" y2="11" stroke="currentColor" stroke-width="2"></line>
												...
												<div fl-accordion-content class="accordion_content">
													<div class="accordion_body">
														<p class="text-wrap-pretty">Future-proof content distribution. Create and publish content seamlessly throughout your website with strategically structured CMS setup.<br></p>
													</div>
												</div>
											</div>
										</div>
										<div slide-animation-item class="services_item">
											<div fl-accordion-item class="services_item-inner">
												<div fl-accordion-header class="accordion_header">
													<h3 data-blur-scroll class="work_item-heading">Wordpress CMS</h3>
													<div fl-accordion-arrow>
														<svg xmlns="http://www.w3.org/2000/svg" width="100%" viewbox="0 0 22 22" fill="none" class="works_arrow">
															<line x1="11" y1="4.37114e-08" x2="11" y2="22" stroke="currentColor" stroke-width="2"></line>
															<line x1="22" y1="11" x2="-8.74228e-08" y2="11" stroke="currentColor" stroke-width="2"></line>
										...
										<div slide-animation-item class="services_item">
											<div fl-accordion-item class="services_item-inner">
												<div fl-accordion-header class="accordion_header">
													<h3 data-blur-scroll class="work_item-heading">Custom API integrations</h3>
													<div fl-accordion-arrow>
														<svg xmlns="http://www.w3.org/2000/svg" width="100%" viewbox="0 0 22 22" fill="none" class="works_arrow">
															<line x1="11" y1="4.37114e-08" x2="11" y2="22" stroke="currentColor" stroke-width="2"></line>
															<line x1="22" y1="11" x2="-8.74228e-08" y2="11" stroke="currentColor" stroke-width="2"></line>
												...
												<div fl-accordion-content class="accordion_content">
													<div class="accordion_body">
														<p>Building web platforms with no limits. We empower your website with dynamic functionality by integrating custom APIs for a seamless user experience.<br></p>
													</div>
												</div>
											</div>
										</div>
										<div slide-animation-item class="services_item">
											<div fl-accordion-item class="services_item-inner">
												<div fl-accordion-header class="accordion_header">
													<h3 data-blur-scroll class="work_item-heading">Website automatization</h3>
													<div fl-accordion-arrow>
														<svg xmlns="http://www.w3.org/2000/svg" width="100%" viewbox="0 0 22 22" fill="none" class="works_arrow">
															<line x1="11" y1="4.37114e-08" x2="11" y2="22" stroke="currentColor" stroke-width="2"></line>
															<line x1="22" y1="11" x2="-8.74228e-08" y2="11" stroke="currentColor" stroke-width="2"></line>
												...
												<div fl-accordion-content class="accordion_content">
													<div class="accordion_body">
														<p>We're like treasure hunters, uncovering gems of insight to chart your path to growth and genuine connections. With strategies as unique as fingerprints, we navigate complexities, turning challenges into stepping stones for success.<br></p>
													</div>
												</div>
											</div>
										</div>
										<div slide-animation-item class="services_item">
											<div fl-accordion-item class="services_item-inner">
												<div fl-accordion-header class="accordion_header">
													<h3 data-blur-scroll class="work_item-heading">Animations and interactions</h3>
													<div fl-accordion-arrow>
														<svg xmlns="http://www.w3.org/2000/svg" width="100%" viewbox="0 0 22 22" fill="none" class="works_arrow">
															<line x1="11" y1="4.37114e-08" x2="11" y2="22" stroke="currentColor" stroke-width="2"></line>
															<line x1="22" y1="11" x2="-8.74228e-08" y2="11" stroke="currentColor" stroke-width="2"></line>
												...
												<div fl-accordion-content class="accordion_content">
													<div class="accordion_body">
														<p>Creating engaging website experience with custom animations and interactions. Your brand is not boring, neither should your website be.<br></p>
													</div>
												</div>
											</div>
										</div>
										<div slide-animation-item class="services_item">
											<div fl-accordion-item class="services_item-inner">
												<div fl-accordion-header class="accordion_header">
													<h3 data-blur-scroll class="work_item-heading">Multi-lingual solution implementation</h3>
													<div fl-accordion-arrow>
														<svg xmlns="http://www.w3.org/2000/svg" width="100%" viewbox="0 0 22 22" fill="none" class="works_arrow">
															<line x1="11" y1="4.37114e-08" x2="11" y2="22" stroke="currentColor" stroke-width="2"></line>
															<line x1="22" y1="11" x2="-8.74228e-08" y2="11" stroke="currentColor" stroke-width="2"></line>
												...
												<div fl-accordion-content class="accordion_content">
													<div class="accordion_body">
														<p>Make your website globally accessible and enhance user experience with reliable multi-lingual solutions.<br></p>
													</div>
												</div>
											</div>
										</div>
